...
class CabinetController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('accountant.cabinet.list', compact('cabinet', 'option', 'center', 'cabinet1'));
    }
...
//        dd(DB::getQueryLog());
        ...
        return view('accountant.cabinet.list', compact('cabinet', 'option', 'center', 'cabinet1', 'isncab', 'isdeayt', 'id_center'));
    ...
    public function create()
    {
        ...
        return view('accountant.cabinet.add', compact('option','center'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->input('ids') == null)
            return redirect()->route('module.cabinet.create');
        else
            return redirect()->route('module.cabinet.index');
    }
    ...
    public function edit($id)
    {
        ...
        $center = Center::all();
        $option = Options::query()->where('category', 'cabinet')->orderby('id_sort', 'asc')->get();
        return view('accountant.cabinet.edit', compact('option', 'id', 'center'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('module.cabinet.edit', $id);
    }
