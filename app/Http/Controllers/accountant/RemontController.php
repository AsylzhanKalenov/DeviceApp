...
class RemontController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('accountant.remont.list', compact('catalog', 'option', 'center', 'cabinet1'));
    }
    ...
    public function show_rem($id)
    {
        ...
        return view('accountant.remont.show_rem', compact('remont', 'type', 'isp', 'types', 'isps'));
    ...
    public function added(){
        ...
        return view('accountant.remont.added', compact('catalog', 'option', 'center', 'cabinet1'));
...
//        dd(DB::getQueryLog());
            ...
            return view('accountant.remont.list_archive', compact('id_center', 'catalog', 'option', 'center', 'cabinet1', 'isncab'));
...
//        dd(DB::getQueryLog());
        ...
        return view('accountant.remont.list_archive', compact('catalog', 'option', 'center', 'cabinet1'));
    ...
    public function new_order(){
        ...
        return view('accountant.remont.add_order',
            [
                'service' => $service,
                'center' => $center
            ]);
    ...
    public function create()
    {
        ...
        return view('accountant.remont.add',compact('service'));
    }
...
//        $rem = Remont::query()->create($arr);
        ...
        return view('accountant.remont.add',compact('service', 'id', 'success'));
    ...
    public function show($id)
    {
        ...
        return view('accountant.remont.show', compact('remont', 'id', 'option', 'service'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('accountant.remont.add',compact('service', 'id'));
    }
