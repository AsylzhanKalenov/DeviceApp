...
@section('content')
        ...
        <table class="table-striped table-hover table-border" width="100%">
            ...
            @foreach($remont1 as $r)
                <tr>
                    ...
                    <td align="center" style="padding:5px;"><a href="{{route('accountant.remont.show_rem', $r->id)}}" title="Показать"><i class="icon-circle-arrow-up"></i></a></td>
                </tr>
            @endforeach
    ...
    <form action="{{route('accountant.remont.update', $remont->id)}}" method="post" rel="ajax_form">
