...
@section('content')
    ...
    <div class="tabbable tabs-top">
        ...
        <ul class="nav nav-tabs">
            ...
            <li><a href="{{route('accountant.remont.index')}}">Заявки</a></li>

            <li class="active"><a href="{{route('accountant.remont.archive')}}">Архив</a></li>
        ...
        <div class="tab-content">
            ...
            <form name="form" method="get" action="{{route('accountant.remont.archive')}}" rel="ajax_form">
