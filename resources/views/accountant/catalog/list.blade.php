...
@section('content')
    ...
    <div class="tabbable tabs-top">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="{{route('accountant.catalog.index')}}">Список оборудования</a></li>
        ...
        <div class="tab-content">
            ...
            <script>
                ...
                function export_data(){
                    ...
                    $.ajax({
                        ...
                        method: 'POST',
                        data: {do: 'export_catalog',center: center, ncab: ncab, _token: $('input[name="_token"]').val()},
                        dataType: 'json',
                ...
                function get_ser_page(num) {
                    ...
                    $.ajax({
                        url: "{{ route('accountant.catalog.list') }}",
                        method: 'POST',
            ...
            <form name="form" action="{{route('accountant.catalog.list')}}" method="POST">
                @csrf
