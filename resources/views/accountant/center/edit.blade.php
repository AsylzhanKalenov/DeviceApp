...
@section('content')
    ...
    <div class="tabbable tabs-top">
        <ul class="nav nav-tabs">
            ...
            <li class="active"><a href="/accountant/center/edit">Редактирование центра</a></li>
        ...
        <div class="tab-content">
            ...
            <form method="post" rel="ajax_form" action="{{route('accountant.center.update', $id->id)}}" enctype="multipart/form-data">
                @csrf
                {{ method_field('PATCH') }}
