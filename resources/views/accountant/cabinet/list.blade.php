...
@section('content')
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a href="{{route('accountant.cabinet.index')}}">Список кабинетов</a></li>

        <li ><a href="{{route('accountant.cabinet.create')}}">Добавление кабинета</a></li>


        <li><a href="/accountant/cabinet/edit">Редактирование кабинета</a></li>
    ...
    <div class="tab-content">
        ...
        <form name="form" action="{{route('accountant.cabinet.list')}}" method="POST">
        @csrf
        ...
        <table class="table-striped" width="100%">
            ...
            <tr>
                ...
                <th>
                    ...
                    <a href="/accountant/cabinet/list/">Центр</a>

                </th>

                @foreach($option as $o)
                    <th><a href="/accountant/cabinet/list/" style=" white-space:nowrap">{{$o->name_ru}}</a></th>
                    @endforeach
            ...
            @foreach($cabinet as $ca)
                ...
                @endforeach
                    ...
                    <td align="right" width="70">
                        ...
                        <a href="/admin/center/show/id" title="Просмотреть"><i class="icon-circle-arrow-up"></i></a> | <a href="{{route('accountant.cabinet.edit', $ca->id)}}" title="Редактировать"><i class="icon-edit"></i></a>
...
<script>
...

    {
...

        {
            ...
            location.href='/accountant/cabinet/delete/'+id;
