...
@section('content')
    ...
    <div class="tabbable tabs-right">
        <ul class="nav nav-tabs">
            <li><a href="{{route('module.catalog.index')}}">Список оборудования</a></li>

            <li ><a href="{{route('module.catalog.create')}}">Добавление оборудования</a></li>

            <li><a href="/admin/catalog/edit">Редактирование оборудования</a></li>

            <li class="active"><a href="{{route('option.list', 'catalog')}}">Настройка полей</a></li>
        ...
        <div class="tab-content">
            ...
            <form id="form" name="form" method="post" action="{{isset($val->id)?route('option.update', $val->id):route('option.add_place')}}" rel="ajax_form"  enctype="multipart/form-data" >
                @csrf
                <input type="hidden" name="category" value="cabinet">
