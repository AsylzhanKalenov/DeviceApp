...
<div class="tabbable tabs-top">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="{{route('module.remont.added')}}">Заявки</a></li>
    ...
    <div class="tab-content">
        ...
        <form name="form" method="post" action="/operator/remont/added" rel="ajax_form">
            ...
            @foreach($catalog as $c)
                ...
                <tr>
                    ...
                    <td align="right" width="70">
                        <form id="delete-form-{{ $c->cid }}" method="post"
                              action="{{ route('module.cabinet.destroy',$c->cid) }}"
                              style="display: none">
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
                        </form>

                        <a href="{{route('module.remont.show', $c->cid)}}" title="Просмотреть"><i class="icon-circle-arrow-up"></i></a> | <a href="{{route('module.cabinet.edit', $c->cid)}}" title="Редактировать"><i class="icon-edit"></i></a> |
                        <a href="" onclick="
