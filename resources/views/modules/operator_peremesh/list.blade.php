...
@section('content')
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="{{route('admin.peremesh.list_oper')}}">Переместить оборудование</a></li>
        <li ><a href="{{route('admin.peremesh.list_pere')}}">История перемещение</a></li>
    </ul>
    ...
    <script>
        ...
        function get_ser() {
            ...
            $.ajax({
                url: "{{ route('admin.peremesh.index') }}",
                method: 'POST',
        ...
        function get_ser_page(num) {
            ...
            $.ajax({
                url: "{{ route('admin.peremesh.list_oper_search') }}",
                method: 'POST',
    ...
    <form name="form" method="post" action="{{route('admin.peremesh.list_oper_search')}}" rel="ajax_form">
        @csrf
        ...
        @foreach($catalog as $c)
            ...
            <tr>
                ...
                @endforeach
                    ...
                    <td align="center" style="padding:5px; text-align:center"><a href="{{route('admin.peremesh.show_oper', $c["id"])}}" title="Переместить"><i class="icon-circle-arrow-up"></i></a>
