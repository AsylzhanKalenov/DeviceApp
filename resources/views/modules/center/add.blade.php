...
@section('content')
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="{{route('admin.center.create')}}">Добавление центра</a></li>
    ...
    <div class="tab-content">
        ...
        <form method="post" rel="ajax_form" action="{{route('admin.center.store')}}" enctype="multipart/form-data">
            @csrf
