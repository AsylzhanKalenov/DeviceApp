...
@section('content')
    ...
    <div class="tabbable tabs-top">
        ...
        <ul class="nav nav-tabs">
            ...
            <li><a href="{{route('dispatcher.remont.index')}}">Заявки</a></li>

            <li class="active"><a href="{{route('dispatcher.remont.archive')}}">Архив</a></li>
        ...
        <div class="tab-content">
            ...
            <form name="form" method="get" action="{{route('dispatcher.remont.archive')}}" rel="ajax_form">
                ...
                <table width="100%">
                        ...
                        <td style="padding:5px;">
                            ...
                            <select name="ncab" id="ncab" style="width:150px;padding:2px; font-size:12px; height:auto;" >
                                ...
                                @foreach($cabinet1 as $ca)
                                    <option value="{{$ca->id}}" {{isset($isncab)?($ca->id==$isncab?'selected':''):''}}>{{$ca->nomer.'('.$ca->deayt}})</option>
                                @endforeach
                            </select>
                        </td>
                    ...
                    <tr>
                        <td style="padding:5px;">
                            Дата <input type="text" name="data1" alt="data" id="data1" value="{{@$data1}}" style="padding:2px; font-size:12px; height:auto; width:70px;"> - <input type="text"  alt="data" name="data2" id="data2" value="{{@$data2}}" style="padding:2px; font-size:12px; height:auto; width:70px;">
                        </td>
                        <td style="padding:5px;">
                        </td>
                        <td style="padding:5px;">
                    ...
                    @foreach($catalog as $c)
                        ...
                        <tr>
                            ...
                            <td align="right" width="70">
                                ...
                                {{--                              action="{{ route('operator.cabinet.destroy',$c->id) }}"--}}
                                {{--                              style="display: none">--}}
                                {{--                            {{ csrf_field() }}--}}
                                {{--                            {{ method_field('DELETE') }}--}}
                                {{--                        </form>--}}

                                <a href="{{route('operator.remont.show_added', $c->idd)}}" title="Просмотреть"><i class="icon-circle-arrow-up"></i></a>
                                {{--                        | <a href="{{route('operator.remont.edit', $ca->id)}}" title="Редактировать"><i class="icon-edit"></i></a> |--}}
                                {{--                        <a href="" onclick="--}}
