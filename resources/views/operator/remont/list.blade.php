...
<script>
    ...
    function show_cab(){
        ...
        $.post('/operator/remont',{id:$('#center').val(),center:'1'},function(data){
        ...
        $.post('/operator/remont',{id:$('#center').val(),center:'2'},function(data){
...
<div class="tabbable tabs-top">
    ...
    <div class="tab-content">
        ...
        <form name="form" method="post" action="/admin/remont" rel="ajax_form">

            <input type="hidden" name="remont" value="1">
            ...
            @foreach($catalog as $c)
                ...
                @endforeach
                    <td align="right" width="70">
                        ...
                        <a href="{{route('operator.remont.edit', $c->id)}}" title="Подать заявку"><i class="icon-circle-arrow-up"></i></a>
