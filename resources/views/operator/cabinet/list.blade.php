...
@section('content')
    ...
    <div class="tab-content">
        ...
        <form name="form" action="{{route('operator.cabinet.list.search')}}" method="POST">
        @csrf
            ...
            @foreach($cabinet as $ca)
                ...
                @endforeach
                    ...
                    <td align="right" width="70">
                        ...
                        <a href="{{route('operator.cabinet.list.show', $ca->id)}}" title="Просмотреть"><i class="icon-circle-arrow-up"></i></a>
